...
* [`src/scanapp1/`](src/scanapp1/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/scanapp1/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `scanapp1` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/scanapp1/config.cljs) defaults to `true` in
...
```clj
(ns scanapp1.example
  (:require [scanapp1.config :as config])
